...
import { ItemCart } from "@/features/cart/components/itemCart"

import { useCart, useReset, useDeleteItem } from "@/hooks/recoil/atoms"
import router from "next/router"
import { OutlinedButton } from "ui/buttons"
import { addItemCart, createPurchaseOrder, deleteItemCart, resetCart } from "@/api/fetchApi"
...
export function Cart() {
    ...
    async function handleDelete(productId) {
        ...
        const deleteProduct = await deleteItemCart(productId)
        console.log("eliminar producto", deleteProduct)
